...
Note that this README, and likely some of the configuration, is taken from Ryan McGeary (http://github.com/rmm5t).
Ryan has been an invaluable friend from whom I've learned a great deal over last couple years.
